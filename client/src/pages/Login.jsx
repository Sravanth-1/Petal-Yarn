...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.needsVerification) {
                setShowOTP(true);
                setError(
                    'Your account needs a little verification. A new OTP has been sent to your email. ♡'
                );
            } else {
    ...
    return (
        <div className="min-h-[calc(100vh-80px)] bg-[#fff9fb] flex items-center justify-center px-4 py-12 relative overflow-hidden">
            ...
            <div className="absolute -top-32 -left-32 w-80 h-80 bg-[#f9d6e3] rounded-full opacity-60"></div>

            <div className="absolute -bottom-40 -right-32 w-96 h-96 bg-[#fce8ef] rounded-full opacity-70"></div>

            <div className="absolute top-20 right-[15%] text-pink-200 text-2xl rotate-12">
                ♡
            </div>

            <div className="absolute bottom-24 left-[15%] text-pink-200 text-xl -rotate-12">
                ✦
            </div>
            ...
            <div className="relative w-full max-w-5xl bg-white rounded-[2rem] shadow-xl border border-pink-100 overflow-hidden">
                ...
                <div className="grid md:grid-cols-2">
                    ...
                    <div className="hidden md:flex relative bg-[#fff0f5] p-12 flex-col justify-between overflow-hidden">
                        ...
                        <div className="absolute -top-24 -right-24 w-64 h-64 bg-[#f7cfdd] rounded-full opacity-60"></div>

                        <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-[#fce0e9] rounded-full opacity-70"></div>
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <p className="mt-4 text-[#927581] leading-relaxed max-w-sm mx-auto">
                                Your little handmade treasures are waiting
                                for you. Come on in and see what's new. 🧶
                            </p>
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-[#947782] mt-2 leading-relaxed">
                                {showOTP
                                    ...
                                    : 'Sign in to continue exploring your handmade favorites.'}
                            </p>
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <label className="text-sm font-bold text-[#634650]">
                                                Password
                                            </label>
